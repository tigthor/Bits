...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 50000
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 50001
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 50000
	%{_sbindir}/semanage port -d -p tcp 50001
	for selinuxvariant in %{selinux_variants}; do
