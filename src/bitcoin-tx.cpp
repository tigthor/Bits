...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gamecredits-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gamecredits-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamecredits transaction") + "\n" +
              "  gamecredits-tx [options] -create [commands]   " + _("Create hex-encoded gamecredits transaction") + "\n" +
              "\n";
