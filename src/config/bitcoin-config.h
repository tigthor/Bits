...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The GameCredits Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "GameCredits Core"
...
#define PACKAGE_BUGREPORT "https://github.com/gamecredits-project/gamecredits/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GameCredits Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GameCredits Core 0.15.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gamecredits"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://gamecredits.org/"
